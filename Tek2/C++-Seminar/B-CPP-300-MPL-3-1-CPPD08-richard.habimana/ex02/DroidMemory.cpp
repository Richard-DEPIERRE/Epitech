...
DroidMemory::DroidMemory(): _exp((size_t)0), _fingerprint((size_t)random())
{
}
...
bool DroidMemory::operator==(const DroidMemory &new_droid) const
{
    return (new_droid.getExp() == getExp() && new_droid.getFingerprint() == getFingerprint());
}
...
bool DroidMemory::operator<(const DroidMemory &new_droid) const
{
    return (new_droid.getExp() < getExp());
}
